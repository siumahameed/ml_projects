...
├── models/
│   ├── model.pkl # Trained ML model (on full 160K data)
│   └── labels.pkl # Label names
├── train_sample.csv # Sample data (15K rows) - for practice only
...
- **Sample Data**: `train_sample.csv` contains 15,000 rows for educational practice
- **Full Data**: The trained model (`model.pkl`) was trained on the full dataset (160,000+ comments)
- **Full Dataset**: [Download from Kaggle](https://www.kaggle.com/datasets/siumahameedbhuiyain/toxic-comment-classification)
